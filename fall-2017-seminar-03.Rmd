...
Now you trying creating a plot of the `pctUnins` data - the percent uninsured - in the `insMap` data frame. We've started the code here, you just need to fill in the data frame and variable name in the appropriate places:
